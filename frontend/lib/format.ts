...
/**
 * ค่าผลสำหรับแสดงบนจอ (จุดทศนิยม "." เสมอ) — ใบยุโรปใช้ "," เป็นทศนิยม คนไทยอ่านเป็นหลักพัน, resultRaw เก็บของเดิมไว้
 */
...
/** ช่องผลที่หน้างานใช้ — ไม่มี "ข้าม": ผ่าน / ผ่านแต่ต้องตรวจ / ไม่ผ่าน
