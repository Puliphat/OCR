...
// ★ กำกวมแบบที่ยัง "ตัดสินไม่ได้" เท่านั้นถึงนับ ★ — เลขตัวอื่นในกลุ่มเดียวกันพินสเกลให้ได้ = จบ ไม่ต้องเตือน
//   เกณฑ์ "0.920~1,420": 0.920 ยืนยันว่า 1,420 คือ 1.42 ไม่ใช่ 1420 → ค่าที่อ่านอยู่ถูกแล้ว
//   ★ anchor มาจากกลุ่มตัวเองเท่านั้น ★ (เกณฑ์พินเกณฑ์ · ค่าผลพินค่าผล) ไม่ยืมข้ามฝั่ง —
//     ถ้าให้ค่าผลพินสเกลของเกณฑ์ ของที่หลุดเกณฑ์จริงจะลากเกณฑ์มาหาตัวเองแล้วกลายเป็น PASS ปลอม
//   anchor ชี้ว่าควรอ่านแบบหลักพัน = ค่าที่อ่านอยู่ผิด 1000 เท่า → ยังกำกวม (ไม่แก้เงียบ ๆ ให้คนดูแทน)
